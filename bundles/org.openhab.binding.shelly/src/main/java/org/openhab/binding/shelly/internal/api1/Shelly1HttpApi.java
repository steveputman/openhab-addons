...
public class Shelly1HttpApi extends ShellyHttpClient implements ShellyApiInterface {
    ...
    public void setTemperature(int value) throws ShellyApiException {
        httpRequest("/thermostat/0?target_t_enabled=1&target_t=" + value);
    }
    ...
    public void setProfile(int value) throws ShellyApiException {
        httpRequest("/settings/thermostat/0?schedule_profile=" + value);
    }

    @Override
    public void setValvePosition(double value) throws ShellyApiException {
        httpRequest("/thermostat/0?pos=" + value); // percentage to open the valve
    }

    @Override
    public void setBoostTime(int value) throws ShellyApiException {
        httpRequest("/settings/thermostat/0?boost_minutes=" + value);
    }
